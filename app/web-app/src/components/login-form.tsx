  ...
  return (
    <Card className="w-full max-w-sm mx-auto bg-white/50 backdrop-blur-md border-slate-300/50 shadow-xl">
      <CardHeader>
        ...
        <CardDescription className="text-center text-slate-700 text-base">
      ...
      <CardContent>
        <div className="grid gap-4">
          ...
          <div className="mt-4 text-center text-sm text-slate-700">
            ...
            <a 
              href="/terms" 
              className="underline underline-offset-4 text-slate-800 hover:text-slate-900 focus:text-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2 rounded transition-colors"
